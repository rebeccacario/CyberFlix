...
public class ServletUtils {
	...
	private final static String PROJECT_NAME         = "CyberFlix";
	...
	private final static String PROJECT_FILES        =  PROJECT_NAME + "/inputFiles"; // changed this
    ...
    public static void setAbsolutePath (ServletConfig config) {
		...
		System.out.println(realPathWebInf);
		int pluginLocation    = realPathWebInf.indexOf(".") + 16; // and changed this
